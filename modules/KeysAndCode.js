export const eventCode = ['Backquote', 'Digit1', 'Digit2', 'Digit3', 'Digit4', 'Digit5', 'Digit6',
  ...
  'KeyV', 'KeyB', 'KeyN', 'KeyM', 'Comma', 'Period', 'ArrowUp', 'Slash', 'ControlLeft', 'AltLeft', 'Space',
  'ArrowLeft', 'ArrowDown', 'ArrowRight'];

export const rusKey = ['`', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '-', '=',
  'Backspace', 'Tab', 'й', 'ц', 'у', 'к', 'е', 'н', 'г', 'ш', 'щ', 'з', 'х', 'ъ', 'ё',
  'CapsLock', 'ф', 'ы', 'в', 'а', 'п', 'р', 'о', 'л', 'д', 'ж', 'э', 'Enter', 'Shift',
  'я', 'ч', 'с', 'м', 'и', 'т', 'ь', 'б', 'ю', ' ▲ ', '/', 'Ctr', 'Alt', ' ', ' ◄ ', ' ▼ ', ' ► '];

export const engKey = ['`', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '-', '=',
  'Backspace', 'Tab', 'q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p', '[', ']', '|',
  'CapsLock', 'a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l', ';', "'", 'Enter', 'Shift',
  'z', 'x', 'c', 'v', 'b', 'n', 'm', ',', '.', ' ▲ ', '/', 'Ctr', 'Alt', ' ', ' ◄ ', ' ▼ ', ' ► '];
